...
import { TOKEN_ABI, POT_ABI, ABYSS_POT_CA, NULL_ADDR } from "../web3/config";
import {
  timeAgo,
...
function Dapp() {
  ...
  const validateBidTransaction = useCallback(() => {
    ...
    if (!isLoadingBalance && balance !== undefined && bidAmount !== undefined) {
      if (balance < bidAmount) {
        errors.push(
          `Insufficient token balance. You need ${formatTokenAmount(
            bidAmount,
            decimals
          )} ${symbol} but only have ${formatTokenAmount(
            balance,
            decimals
          )} ${symbol}`
        );
  ...
  const handleApprove = useCallback(() => {
    ...
    if (allowance !== undefined && allowance >= bidAmount) {
      setErrorMsg(
        "Approval not needed - you already have sufficient allowance"
      );
      return;
    }
    ...
    <div className="">
      ...
      <div className="relative mt-[88px] max-w-[1300px] mx-auto px-4 lg:px-0">
        ...
        `}
                    >
                      ...
                      {getValidationStatus().gameExpired ||
                      getValidationStatus().timerExpired ? (
                        <>
                        ...
                        {isPending && (
                          <div className="bg-yellow-900/50 border border-yellow-500 text-yellow-300 px-4 py-3 rounded-lg">
                            <div className="flex items-center">
                              ...
                              <span>
                                Transaction pending - please sign in your
                                wallet...
                              </span>
                            </div>
                          </div>
      ...
      <div className="max-w-[1300px] mx-auto my-10 px-4">
        ...
        <div className="">
          ...
          {activeTab === "tab3" && (
            <div className="">
              <div className="p-6 rounded-md shadow-md mb-6 flex flex-col items-start overflow-x-auto custom-scrollbar mt-6">
                    ...
                    return (
                      <div className="overflow-x-auto custom-scrollbar mt-6">
                        <div className="bg-color-cta-Background p-5 rounded-lg shadow">
                          ...
                          <div className=" mt-6 border border-HowTo-Cards-border rounded-lg">
